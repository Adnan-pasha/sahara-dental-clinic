...
export function PhoneIcon({ size = 16, className }: IconProps) {
  return (
    <svg {...props(size)} className={className}>
      <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 13.6 19.79 19.79 0 0 1 1.61 5 2 2 0 0 1 3.6 3h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 10.91a16 16 0 0 0 6 6l.92-.92a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 18.1z" />
    </svg>
  );
}
...
export function SmileIcon({ size = 24, className }: IconProps) {
  return (
    <svg {...{ ...props(size), strokeWidth: 1.5 }} className={className}>
